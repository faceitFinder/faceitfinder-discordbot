...
const getHistory = async (playerId, limit = 1, from = null, to = null) => await Faceit.fetchData(`https://open.faceit.com/data/v4/players/${playerId}/history?game=csgo&offset=0&limit=${limit}&from=${from}&to=${to}`, 'Couldn\'t get csgo history')
