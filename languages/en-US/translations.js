...
module.exports = {
  command: {
    ...
    dailystats: {
      description: 'Displays the stats of the chosen day, with elo graph of the day',
    },
    find: {
    ...
    map: {
      description: 'Displays the stats of the chosen map',
    },
    monthstats: {
      description: 'Displays the stats of the chosen month, with elo graph of the month',
    },
    roles: {
    ...
    weekstats: {
      description: 'Displays the stats of the chosen week, with elo graph of the week',
    },
    yearstats: {
      description: 'Displays the stats of the chosen year, with elo graph of the year',
    }
  },
  options: {
