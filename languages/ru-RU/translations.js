...
base.error.command.faceitCsgoStatsNotFound = 'Статистика Faceit CS:GO не найдена';
...
base.error.command.invalidElo = 'Минимальное значение ELO должно быть меньше максимального значения ELO';
